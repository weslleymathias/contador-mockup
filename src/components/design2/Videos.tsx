    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        {currentVideos.map((video) => (
          ...
          >
            {/* Thumbnail */}
            <div className="relative bg-gray-800 aspect-video flex items-center justify-center cursor-pointer"
              onClick={() => handlePlay(video.id)}
            >
              <div className="absolute inset-0 bg-gradient-to-br from-gray-600 to-gray-900"></div>
              <Play className="w-16 h-16 text-white opacity-70 relative z-10 hover:opacity-100 transition-opacity" />
